...
--Muestra columnas especificas de una tabla (muestra las columnas CategoryName y Description de la tabla Categories.
...
--ORDER BY es una condicion que ordena las filas del conjunto de resultados devueltos por algunas columnas o expresiones.
SELECT * FROM Customers
